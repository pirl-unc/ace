...
def run_ace_deconvolve(
    ...
    df_readout_ = df_readout[df_readout['spot_count'] >= empirical_min_spot_count]
    ...
    df_statistical.drop(columns=['peptide_sequence', 'hit_pool_ids', 'hit_pools_count', 'deconvolution_result'], inplace=True)
