...
| -------------------------- | ---------------------------------------------------------------------- |
| `--plate-size`             | Number of wells on plate. Allowed values: 24, 48, 96, 384 (default: 96). |
| `--mode`                   | Configuration generation mode. Allowed values: golfy, cpsat_solver (default: golfy). |
| `--sequence-similarity-threshold` | Sequence similarity threshold (default: 0.7). A higher threshold leads to more stringent peptide pairing. |
