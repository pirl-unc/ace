...
This command deconvolves hit peptides from ELISpot results.
...
| `--assignment-excel-file`   | ELISpot assignment Excel file. Expected columns: 'peptide_id', 'peptide_sequence', 'plate_id', 'well_id' in a sheet named 'assignment'. |
| `--output-excel-file`       | Output deconvolution Excel file.                                         |
| `--min-positive-pool-spot-count` | Minimum spot count for a pool to be considered a positive pool.     |

| Optional Parameter          | Description                                                              |
| --------------------------- | ------------------------------------------------------------------------ |
| `--statistical-deconvolution-method` | Statistical deconvolution mode (default: em).                   |
| `--min-peptide-activity` | Minimum estimated activity of a peptide to be considered for hit set. This value is used if when '--mode em' or '--mode lasso' (default: 1.0). |
